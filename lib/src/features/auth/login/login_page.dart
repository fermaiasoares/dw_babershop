...
import 'package:dw_babershop/src/features/auth/login/login_vm.dart';
    ...
    ref.listen(loginVmProvider, (_, state) {
      switch (state) {
        ...
        case LoginState(status: LoginStateStatus.error, :final errorMessage?):
          Messages.showErrors(errorMessage, context);
        case LoginState(status: LoginStateStatus.error):
          Messages.showErrors('Erro ao realizar login', context);
        ...
        child: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                ImagesConstanst.backgroundChair,
              ),
              opacity: 0.2,
              fit: BoxFit.cover,
            ),
                  ...
                  child: Stack(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Image.asset(ImagesConstanst.imageLogo),
                          const SizedBox(
                            height: 24,
                          ),
                          TextFormField(
